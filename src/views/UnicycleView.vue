<template>
    ...
    <div class="flex flex-col flex-wrap md:mx-16 mx-10 my-5 mt-10 lg:mx-20">
        <Loader />
        <h1 class="text-white font-poppins font-thin relative tracking-widest text-3xl my-2 md:text-5xl lg:text-7xl laptoplarge:text-[4.6rem]">unicycle<span class="w-24 absolute bottom-4 lg:bottom-7 hidden mx-5 bg-white h-[0.3px] md:w-16 lg:w-28 laptoplarge:w-32 laptopmax:w-48"></span>
        </h1>
    </div>
...
<!--COLOR PALETTE-->
                ...
                <div class="flex flex-wrap gap-10 my-5 justify-center">
                    ...
                    <div class="w-16 h-16 lg:w-20 lg:h-20 rounded-md unidarkgreen transition-all hover:opacity-50 duration-500"></div>
                    <div class="w-16 h-16 lg:w-20 lg:h-20 unigreen rounded-md transition-all hover:opacity-50 duration-500"></div>
