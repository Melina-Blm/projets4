<template>
    ...
    <Loader/>
    <h1 class="text-white font-gloock relative tracking-widest text-4xl my-2 md:text-5xl lg:text-7xl laptoplarge:text-[4.6rem]">askme<span class="w-24 absolute bottom-4 lg:bottom-7 mx-5 bg-white h-[0.3px] md:w-16 lg:w-28 laptoplarge:w-32 laptopmax:w-48"></span></h1>
