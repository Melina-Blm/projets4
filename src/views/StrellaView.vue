<template>
    <div class="flex flex-col flex-wrap md:mx-16 mx-10 my-5 mt-10 lg:mx-20 ">
        <Loader />
        <h1 class="text-white font-poppins font-thin relative tracking-widest text-4xl my-5 md:text-5xl lg:text-7xl laptoplarge:text-[4.6rem]">strella</h1>
    </div>
...
<!--COLOR PALETTE-->
                ...
                <div class="flex flex-wrap gap-10 my-5 justify-center">
                    ...
                    <div class="w-16 h-16 lg:w-20 lg:h-20 rounded-md purplee transition-all hover:opacity-50 duration-500"></div>
                    <div class="w-16 h-16 lg:w-20 lg:h-20 beigestrella rounded-md transition-all hover:opacity-50 duration-500"></div>
                    <div class="w-16 h-16 lg:w-20 lg:h-20 strelladark  border-[1px] border-zinc-700 rounded-md transition-all hover:opacity-50 duration-500"></div>
                </div>
