<template>
    ...
    <div class="flex flex-col flex-wrap md:mx-16 mx-10 my-5 mt-10 lg:mx-20 ">
        <Loader/>
        <h1 class="text-white font-gloock relative tracking-widest text-3xl my-5 md:text-5xl lg:text-7xl laptoplarge:text-[4.6rem]">mmi international<span class="w-24 absolute bottom-4 lg:bottom-7 hidden  mx-5 bg-white h-[0.3px] md:w-16 lg:w-28 laptoplarge:w-32 laptopmax:w-48"></span>
        </h1>
    </div>
...
<!--COLOR PALETTE-->
                    ...
                    <div class="flex flex-wrap gap-10 my-5 justify-center">
                         <div
                        class="w-16 h-16 lg:w-20 lg:h-20 bg-white rounded-md relative transition-all hover:opacity-50 duration-500"></div>
                    ...
                    <div class="flex gap-3 mt-14 mb-4">
                        ...
                        <p class=" text-zinc-200 font-poppins text-xs md:text-xs font-extralight tracking-wide leading-5  md:leading-5 lg:text-base">I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I’m focused on building accessible, human-centered products at Upstatement.</p>
                            ...
                            <div class="flex flex-wrap gap-10 mt-5 justify-center">
                                ...
                                <img class="w-20 bg-blackpo rounded-2xl p-3" src="../assets/adobe_illustrator.png" alt="icone illustrator">
                                 <img class="w-20 bg-blackpo rounded-2xl p-3" src="../assets/adobe_indesign.png" alt="icone indesign">
                            </div>
                </div>
        </div>
