<template>
       <div class="flex flex-col flex-wrap bg-blackpo border-bluepo border-[1px] mx-5 p-7 px-10 ">
        ...
        <input type="text" required id="name" class="bg-transparent mb-5 pb-2 font-poppins text-xs border-b-[1px] border-zinc-600 lg:text-base text-zinc-500 placeholder-zinc-500 focus:outline-none font-light" placeholder="Name">
